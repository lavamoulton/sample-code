             ...
             implements BSTInterface<T>
{
  ...
  private int recLeafCount(BSTNode<T> element)
	  {
	  if (element == null)
		  return 0;
		  ...
		  return recLeafCount(element.getLeft()) + recLeafCount(element.getRight());
	  ...
	  private int recSingleParentCount(BSTNode<T> element)
	  {
	  if (element == null)
		  return 0;
	  else if (element.getLeft() == null && element.getRight() == null)
		  ...
		  return 1 + recSingleParentCount(element.getLeft()) +
				 recSingleParentCount(element.getRight());
	  else
		  return recSingleParentCount(element.getLeft()) + 
				 recSingleParentCount(element.getRight());
